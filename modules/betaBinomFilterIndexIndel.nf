process betaBinomFilterIndexIndel {
    ...
    script:
    """
    Rscript --vanilla ${projectDir}/bin/beta_binom_filter_index_indel.R --libpath=${projectDir}/lib --cgpvaf_out=${vaf} --match_normal_id=${match_normal_id} --rho_threshold=${rho_threshold} --outdir=. 
    """
